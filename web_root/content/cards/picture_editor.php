...
final class _picture_editorCard extends CardBaseFramework
{
    ...
    public function render(array $context): string
    {
        ...
        return '<div class="picture-editor"
                ...
                data-profile-url="/api/photo-update.php"
                data-final-url="/api/photo-update.php?action=final_profile"
                data-profile-status-url="/api/photo-status.php?image_type=profile&amp;photo_id=' . HelperFramework::escape((string)$photoId) . '"
