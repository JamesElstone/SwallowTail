...
use CardAccessFramework;
use InvalidArgumentException;
use OtpService;
use RequestFramework;
use ResponseFramework;
use ReverseProxyService;
use Throwable;
use UserAuthenticationService;
...
final class SwallowtailSpiceBushRegistrationApiService
{
    ...
    public function handleRegister(RequestFramework $request): ResponseFramework
    {
        ...
        return ResponseFramework::json([
            ...
            'api_url' => $apiUrl,
            'ping_url' => $apiUrl . '/remote-ping.php',
            'raw_upload_url' => $apiUrl . '/upload-raw.php',
            'quick_checksum_url' => $apiUrl . '/upload-checksum.php',
