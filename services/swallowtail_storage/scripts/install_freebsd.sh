...
echo "Optional rc.conf tunables: swallowtail_storage_project_root, swallowtail_storage_python, swallowtail_storage_php, swallowtail_storage_interval_seconds, swallowtail_storage_mount_poll_seconds, swallowtail_storage_migration_item_limit, swallowtail_storage_migration_idle_batch_limit, swallowtail_storage_log, swallowtail_storage_log_level"
